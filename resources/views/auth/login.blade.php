    ...
    <div class="w-96 bg-white p-6 rounded-lg">
        ...
        <form action="{{ route('login') }}" method="post">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="email" id="email" placeholder="Your email" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('email') border-red-500 @enderror" value="{{ old('username') }}">
